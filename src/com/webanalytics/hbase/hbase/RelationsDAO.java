package com.webanalytics.hbase.hbase;
...
import com.webanalytics.hbase.coprocessors.RelationCountProtocol;
import com.webanalytics.hbase.utils.Md5Utils;
...
public class RelationsDAO {
  ...
  public List<com.webanalytics.hbase.model.Relation> listFollows(String fromId) throws IOException {
    return listRelations(FOLLOWS_TABLE_NAME, fromId);
  }

  public List<com.webanalytics.hbase.model.Relation> listFollowedBy(String fromId) throws IOException {
    return listRelations(FOLLOWED_TABLE_NAME, fromId);
  }

  public List<com.webanalytics.hbase.model.Relation> listRelations(byte[] table, String fromId) throws IOException {
    ...
    List<com.webanalytics.hbase.model.Relation> ret
      = new ArrayList<com.webanalytics.hbase.model.Relation>();
  ...
  private static class Relation extends com.webanalytics.hbase.model.Relation {
