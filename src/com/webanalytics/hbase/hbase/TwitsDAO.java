...
public class TwitsDAO {
  ...
  public com.webanalytics.hbase.model.Twit getTwit(String user, DateTime dt) throws IOException {
  ...
  public List<com.webanalytics.hbase.model.Twit> list(String user) throws IOException {

    HTableInterface twits = pool.getTable(TABLE_NAME);

    ResultScanner results = twits.getScanner(mkScan(user));
    List<com.webanalytics.hbase.model.Twit> ret = new ArrayList<com.webanalytics.hbase.model.Twit>();
  ...
  private static class Twit extends com.webanalytics.hbase.model.Twit {
