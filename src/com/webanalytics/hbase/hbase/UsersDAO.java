...
public class UsersDAO {
  ...
  public com.webanalytics.hbase.model.User getUser(String user)
    throws IOException {
    HTableInterface users = pool.getTable(TABLE_NAME);
  ...
  public List<com.webanalytics.hbase.model.User> getUsers()
    throws IOException {
    HTableInterface users = pool.getTable(TABLE_NAME);

    ResultScanner results = users.getScanner(mkScan());
    ArrayList<com.webanalytics.hbase.model.User> ret
      = new ArrayList<com.webanalytics.hbase.model.User>();
  ...
  private static class User
    extends com.webanalytics.hbase.model.User {
